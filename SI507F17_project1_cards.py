...
# Because it's written in a silly way, there are a bunch of edge
# cases of sorts.
def play_war_game(testing=True):
    # Call this with testing = True and it won't print out all the
    # game mechanics, which makes it easier to see tests.
    player1 = Deck()
    player2 = Deck()
...
# id495954957?i=495955054&uo=4" doesn’t understand the “open location”
# message. (-1708) That's an Apple-related error but will not cause you a
